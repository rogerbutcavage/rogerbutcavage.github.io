...
function printPageLoadMessages() {
  ...
  console.log("\n");
  console.log("Also, even though the secrecy of this mission is paramount,");
  console.log("feel free to photograph your journey along the way,")
  console.log("if you so desire.");
  console.log("\n");
